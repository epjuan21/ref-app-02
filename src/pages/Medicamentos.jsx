...
const Medicamentos = () => {
    return (
        <>
            ...
            <Breadcrumbs
                items={[{ label: 'Inicio', to: '/' }, { label: 'Medicamentos', icon: 'M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z' },]}
            />
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <span className="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400 ">Medicamentos</span>
                        </div>
                    </li>
                </ol>
            </nav>
